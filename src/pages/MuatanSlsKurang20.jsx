...
const SPREADSHEET_ID = "1xKpAaS6ric_putyHBCBf6Ui-hL2gamkb4IatP7owGNA";
const GID_DATA        = "236693761";

const CSV_DATA = `https://docs.google.com/spreadsheets/d/${SPREADSHEET_ID}/export?format=csv&gid=${GID_DATA}`;

const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyL_FgeO4x_chIGnBjwDWrweaDEScj6bK7COAg-Vgrw4hjlBSde182vrjNWIWsgcODk/exec";
...
export default function MuatanSlsKurang20() {
      ...
      <header className="relative overflow-hidden" style={{ background: "linear-gradient(135deg,#F5A623 0%,#e8820a 100%)" }}>
        <div className="relative z-10 max-w-6xl mx-auto w-full px-4 sm:px-6 py-6">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <h1 className="text-white text-2xl sm:text-3xl font-black leading-tight">Muatan SLS &lt;20 Keluarga</h1>
